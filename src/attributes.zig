...
const AttributeMap = std.ComptimeStringMap(AttributeTag, .{.{ "Code", "code" }});
...
pub const CodeAttribute = struct {
    ...
    pub fn decode(constant_pool: *const ConstantPool, allocator: *std.mem.Allocator, reader: anytype) !CodeAttribute {
